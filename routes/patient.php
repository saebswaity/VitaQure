...
Route::group(['namespace'=>'Auth','prefix'=>'patient/login','middleware'=>'PatientGuest','as'=>'patient.auth.'],function(){
  //register
  ...
  //login
  Route::get('/login','PatientController@showLoginForm')->name('login');
