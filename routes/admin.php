...
Route::group(['prefix'=>'admin','as'=>'admin.','namespace'=>'Admin','middleware'=>'Admin'],function(){
    ...
    Route::group(['prefix' => 'catogery', 'as' => 'catogery.'], function () {

    Route::get('/', "CatogeryTestsController@show");
    Route::get('create', "CatogeryTestsController@create");
        Route::post('store', "CatogeryTestsController@store")->name('store');
        Route::get('index', "CatogeryTestsController@index");
