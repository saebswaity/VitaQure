        ...
        <div class="row mb-2">
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    <li class="breadcrumb-item"><a href="{{route('patient.index')}}">{{__('Dashboard')}}</a></li>
                                                                    ...
                                                                    <td width="33.33%" class="no-right-border text-center">
                                                                        <table width="100%">
                                                                            ...
                                                                            <tbody>
                                                                                ...
                                                                                @endforeach
                                                                                @for($i=0;$i<$high_still;$i++) <tr class="no-border">
                                            ...
                                            <td width="33.33%" class="no-right-border text-center">
                                                <table width="100%">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        @endforeach
                                                        @for($i=0;$i<$moderate_still;$i++) <tr class="no-border">
                                                            <td class="text-center no-border">-</td>
                                        </tr>
                                        @endfor
                                    </tbody>
                                ...
                                <td width="33.33%" class="text-center">
                                    <table width="100%">
                                        ...
                                        <tbody>
                                            ...
                                            @endforeach
                                            @for($i=0;$i<$resident_still;$i++) <tr class="no-border">
                                                <td class="text-center no-border">-</td>
                                                </tr>
                                                @endfor
                                        </tbody>
