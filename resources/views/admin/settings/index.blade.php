                  ...
                  <div class="row mt-3">
                      ...
                      <div class="card card-primary">
                        ...
                        <div class="card-body">
                          <div class="row">
                            ...
                            <div class="col-lg-12">
                              <div class="form-group">
                                <label for="">{{__('Upload report header')}} </label>
                                <div class="input-group">
                                  <div class="custom-file">
                    ...
                    <div class="col-lg-12">
                      <div class="card card-primary">
                        <div class="card-header">
                          <h5 class="card-title">
                            {{__('Report background')}}
                          </h5>
                        </div>
                        <div class="card-body">
                          <div class="row">
                            <div class="col-lg-12">
                              <label for="reports_show_background_image">{{__('Show background image')}}</label>
                              <br>
                              <label class="switch">
                            ...
                            <div class="col-lg-12">
                              <div class="form-group">
                                <label for="">{{__('Upload report background')}} </label>
                                <div class="input-group">
                                  <div class="custom-file">
                      ...
                      <div class="card card-primary">
                        ...
                        <div class="card-body">
                          <div class="row">
                            ...
                            <div class="col-lg-12">
                              <div class="form-group">
                                <label for="">{{__('Upload report footer')}} </label>
                                <div class="input-group">
                                  <div class="custom-file">
