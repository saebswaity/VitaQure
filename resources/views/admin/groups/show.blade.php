...
<div class="card card-primary">
    ...
    <!-- patient code -->
    <input type="hidden" name="patient_code" @if(isset($group['patient'])) value="{{$group['patient']['code']}}" @endif id="patient_code">
                                ...
                                <th colspan="3">
                                    <table width="100%" class="table table-bordered">
                                        <tbody>
                                            <tr>
                                                <td>
                                                    <span class="page_title">{{__('Patient Code')}} :</span> <span class="data">@if(isset($group['patient']))
                                                        {{$group['patient']['code']}} @endif</span>
                                                </td>
                                                <td>
                                                    <span class="page_title">{{__('Patient Name')}} :</span> <span class="data"> @if(isset($group['patient']))
                                                        {{$group['patient']['name']}} @endif</span>
                                                </td>
                                            </tr>
                                            <tr>
                                                <!--<td>-->
                                                <!--    <span class="page_title">{{__('Age')}} :</span> <span class="data">@if(isset($group['patient']))-->
                                                <!--        {{$group['patient']['age']}} @endif</span>-->

                                                <!--</td>-->
                                                <td>
                                                    <span class="page_title">{{__('Age')}} :</span>
                                                    <span class="data">
                                                        @if(isset($group['patient']) && isset($group['patient']['age']) && $group['patient']['age'] != 0)
                                                        {{$group['patient']['age']}}
                                                        @else
                                                        {{ '' }}
                                                        @endif
                                                ...
                                                <td>
                                                    <span class="page_title">{{__('Gender')}} :</span> <span class="data">@if(isset($group['patient']))
                                                        {{$group['patient']['gender']}} @endif</span>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>
                                                    <span class="page_title">{{__('Doctor')}} :</span> <span class="data">@if(isset($group['doctor']))
                                                ...
                                                <td>
                                                    <span class="page_title">{{__('Date')}} :</span> <span class="data">
                                                        {{($group['created_at']->DiffForHumans())}}</span>
                                                </td>
                                            </tr>
