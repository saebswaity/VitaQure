                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-3 col-md-3 col-sm-3 col-xs-3">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" name="date" class="form-control float-right datepickerrange" @if(request()->has('date')) value="{{request()->get('date')}}" @endif id="date"
                                required>
                            </div>
                        </div>
                        <!-- \date range -->
                        ...
                        <div class="col-lg-2 col-md-2 col-sm-2 col-xs-2">
                            ...
                            <ul class="pl-0" style="list-style-type: none">
                                <li>
                                    <input type="checkbox" name="show_groups" id="show_groups" @if(request()->has('show_groups')) checked @endif>
                                    <label for="show_groups">{{__('Show Group tests')}}</label>
                                </li>
                                <li>
                                    <input type="checkbox" name="show_expenses" id="show_expenses" @if(request()->has('show_expenses')) checked @endif>
                                    <label for="show_expenses">{{__('Show Expenses')}}</label>
                                </li>
                                <li>
                                    <input type="checkbox" name="show_profit" id="show_profit" @if(request()->has('show_profit')) checked @endif>
