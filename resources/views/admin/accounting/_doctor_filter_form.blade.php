                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-3 col-md-3 col-sm-3 col-xs-3">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" name="date" class="form-control float-right datepickerrange" @if(request()->has('date')) value="{{request()->get('date')}}" @endif id="date" required>
                            </div>
                        </div>
                        <!-- \date range -->
                        ...
                        <div class="col-lg-3 col-md-3 col-sm-3 col-xs-3">
                            ...
                            <ul class="pl-0" style="list-style-type: none">
                                ...
                                <li>
                                    <input type="checkbox" name="show_payments" id="show_payments" @if(request()->has('show_payments')) checked @endif>
