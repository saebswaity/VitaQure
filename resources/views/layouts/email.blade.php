                  ...
                  <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
                    <tr>
                      <td>
                        ...
                        <ul class="contact" style="list-style-type:none;padding-left:0px;font-size:16px;color:white;margin-left: -15px;">
                          ...
                          <li><img src="{{url('img/mail.png')}}" style="width: 20px;height:20px;padding-right:10px;">
                            <a href="{{$info['email']}}" style="color:white">{{$info['email']}}</a>
                          </li>
