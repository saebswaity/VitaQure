...
class AccountingController extends Controller
{
  ...
  $pdf = generate_pdf(compact(
    ...
    'cairo' => [
        'R' => base_path('storage/fonts/Cairo/Cairo-Regular.ttf'),
        'B' => base_path('storage/fonts/Cairo/Cairo-Bold.ttf'),
        'I' => base_path('storage/fonts/Cairo/Cairo-Italic.ttf'),
        'BI' => base_path('storage/fonts/Cairo/Cairo-BoldItalic.ttf'),
    ],
]);
