...
class PatientsController extends Controller
{
    ...
    */
    ...
    {
         if ($request->has('age')) {
            // If the request contains the 'dob' field
            $age = $request->age;
            $ageType = $request->input('age_type');

            if ($ageType == 'years') {
                $dob = \Carbon\Carbon::now()->subYears($age)->toDateString();
            } elseif ($ageType == 'months') {
                $dob = \Carbon\Carbon::now()->subMonths($age)->toDateString();
            } else {
                $dob = \Carbon\Carbon::now()->subDays($age)->toDateString();
            }
        }
